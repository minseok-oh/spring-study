...
class PureJdbcCustomerRepositoryTest extends RepositoryTest {

    @Autowired
    @Qualifier("pureJdbcCustomerRepository")
    ...
    void 레포지토리_테스트_환경을_확인한다() {
        assertThat(customerRepository).isInstanceOf(PureJdbcCustomerRepository.class);
    }
